...
<form action="/member" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" name="first_name" required maxlength="50" placeholder="First Name"
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" name="last_name" required maxlength="50" placeholder="Last Name"
                value="{{ old('last_name') }}">
            @if(isset($errors))
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" name="telephone" required maxlength="10" placeholder="Telephone"
                value="{{ old('telephone') }}">
            @if(isset($errors))
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-7">
            <input type="date" class="form-control" name="birth_date" required value="{{ old('birth_date') }}">
            @if(isset($errors))
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-7">
            <input type="date" class="form-control" name="register_date" required value="{{ old('register_date') }}">
            @if(isset($errors))
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-7">
            <input type="number" class="form-control" name="point" min="0" placeholder="Point"
                value="{{ old('point', 0) }}">
            @if(isset($errors))
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-7">
            <input type="file" name="member_pic" accept="image/*"
                class="form-control"
                data-cropper-target="#member_pic_cropped">
            <input type="hidden" name="member_pic_cropped" id="member_pic_cropped">
            @if(isset($errors))

...
<form action="/employee" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" name="nickname" maxlength="50" placeholder="Nickname"
                value="{{ old('nickname') }}">
            @if(isset($errors))
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-7">
            <input type="date" class="form-control" name="hire_date" required value="{{ old('hire_date') }}">
            @if(isset($errors))
